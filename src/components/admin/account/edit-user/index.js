...
class EditUser extends Component {
    constructor(props) {
        ...
        this.state = { loading: false, email: userdata.email, firstName: userdata.firstName, lastName: userdata.lastName, decentralization: userdata.decentrizationId, password: '', confirmPassword: '' ,passworderror:'',confirmPassworderror:''}
    ...
    handleUpdate() {
        ...
        if(isValid){
            if(password === confirmPassword){
                new API().getHttpClient().post('/user/updateUser', {
                    id: this.props.location.state.userId, firstName: this.state.firstName, lastName: this.state.lastName, decentrizationId: this.state.decentralization, password: this.state.password
                }).then((res) => {
            ...
            <Paper >
                ...
                <div className="row">
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <input type="text" className="form-control " id="email" name="email" value={this.state.email} onChange={this.handleChange} disabled />
                    </div>

                    <div className="col-md-6 form-group">

                        <label for="exampleInputEmail1">{t('account.editUser.role')}</label>
                        <select id="role" className="form-control" name="decentralization" value={this.state.decentralization} onChange={this.handleChange}>
                    ...
                    <div className="col-md-6 form-group">
                        <label for="exampleInputEmail1">{t('account.editUser.firstName')}</label>
                        <input type="text" className="form-control " name="firstName" value={this.state.firstName} onChange={this.handleChange} />
                    </div>


                    <div className="col-md-6 form-group">
                        <label for="exampleInputEmail1">{t('account.editUser.lastName')}</label>
                    ...
                    <div className="col-md-6 form-group">
                        <label for="exampleInputEmail1">{t('account.editUser.password')}</label>
                    ...
                    <div className="col-md-6 form-group">
                        <label for="exampleInputEmail1">{t('account.editUser.retype')}</label>
